...
def main():
    def initial_options():
        ...
        st.session_state.user_menu = streamlit_option_menu.option_menu(
            menu_title='What are you looking for? 👀📽️',
            options=['Recommend me a similar movie', 'Details about the searched movie', 'View the entire movie collection'],
        ...
        elif st.session_state.user_menu == 'Details about the searched movie':
            display_movie_details()

        elif st.session_state.user_menu == 'View the entire movie collection':
            paging_movies()
